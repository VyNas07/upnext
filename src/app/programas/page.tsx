...
import { mockPrograms, categories, levels, formats } from '@/data/mockData'

export default function ProgramsPage() {
  const { programs, filters, setFilters, setPrograms, favorites, addToFavorites, removeFromFavorites } = useAppStore()
  const [searchTerm, setSearchTerm] = useState('')
  const [isLoading, setIsLoading] = useState(false)

  useEffect(() => {
    // Initialize programs if not already loaded

...
import { mockPrograms, mockInstitutions } from '@/data/mockData'

export default function ProgramDetailPage() {
  const params = useParams()
  const programId = params.id as string
  const { programs, institutions, favorites, addToFavorites, removeFromFavorites, setPrograms, setInstitutions } = useAppStore()
  ...
  }, [programs.length, setPrograms, setInstitutions])
            ...
            <CardBody>
              <VStack spacing={6} align="stretch">
                <HStack justify="space-between" align="start">
                  ...
                  <VStack spacing={4}>
                    <Tooltip label={favorites.includes(program.id) ? 'Remover dos favoritos' : 'Adicionar aos favoritos'}>
                      <IconButton
                        aria-label="Favoritar"
                        icon={<StarIcon />}
                        size="lg"
                        variant="outline"
                        color={favorites.includes(program.id) ? 'yellow.400' : 'gray.400'}
